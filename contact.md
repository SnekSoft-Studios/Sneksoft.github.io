...
<section class="app-shell page-shell">
  ...
  <div class="glass-block contact-card">
    ...
    <!-- GitHub Button (unchanged, but cleaned) -->
  ...
  <button
    class="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
      ...
      <svg class="h-6 w-6 mr-2" viewBox="0 0 16 16" version="1.1" aria-hidden="true">
        <path
          fill-rule="evenodd"
          d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38
             ...
             2.2.82A7.65 7.65 0 0 1 8 4.98c.68.003 1.36.092 2 .27 1.53-1.04 2.2-.82
    ...
    <!-- Discord Button (new, matching GitHub pill) -->
