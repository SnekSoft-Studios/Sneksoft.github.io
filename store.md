...
<a href="https://www.meta.com/en-gb/experiences/z0n3/32539964462316328/" class="project-card-link">
  <article class="project-card">
    ...
    <div class="project-body">
      <h3>Z0N3</h3>
      <p>Step into Z0N3, an open-world VR street-racing fantasy where every turn, drift, and police chase happens right in front of you. This is racing built for pure adrenaline — no menus, no walls, no limits. Just speed, neon, and chaos.</p>
      <div class="project-meta">
        <div class="meta-tags">
          <span class="meta-tag">VR</span>
          <span class="meta-tag">Quest 2</span>
  ...
  <article class="project-card">
    ...
    <div class="project-body">
      <h3>V1V4R1UM</h3>
      <p>A calming, immersive passthrough-only VR experience where the player cares for, interacts with, and bonds with a realistic virtual pet snake living in their real-world space. The game uses passthrough to seamlessly integrate the snake, terrarium, and interactions into the player’s environment, making the experience feel physical and presence-driven..</p>
      <div class="project-meta">
        <div class="meta-tags">
          <span class="meta-tag">VR</span>
